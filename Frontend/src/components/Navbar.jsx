            ...
            {/* <AnimatePresence>
              {dropdownOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  transition={{ type: 'spring', stiffness: 120, damping: 15 }}
                  className={`absolute w-40 bg-white/50 backdrop-blur-md rounded-md shadow-lg cursor-pointer overflow-hidden ${
                    window.innerWidth >= 768 ? 'right-0 top-10' : 'top-12 left-0'
                  }`}
                >
                  <NavLink
                    to="/profile"
                    className="px-4 py-2 text-gray-800 hover:bg-gray-200 flex items-center gap-2 cursor-pointer "
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2 text-gray-800 hover:bg-gray-200 flex items-center gap-2 cursor-pointer "
                  >
                    <MdLogout size={20} />
                    Logout
                  </button>
